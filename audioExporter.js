			...
			if (bits === 8) {
				...
				if (encodeBetter) {
					for (let i = 0; i < len; i++) {
						...
						offset += 2;
						view.setInt16(offset, (x<0?(x|=0b1000000000000000):x), true);
						offset += 2;
					}
				} else {
					for (let i = 0; i < len; i++) {
