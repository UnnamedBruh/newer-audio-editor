...
const effectsList = [
	...
	[
		...
		'Form: <select id="wasm_biquadfilteri5"><option value="0">(0) ii trans (optimized for performance and memory)</option><option value="1">(1) ii (slightly performant, but numerically imprecise)</option><option value="2">(2) i trans (slightly performant and barely imprecise)</option><option value="3">(3) i (optimized for numerical stability and precision)</option></select><br>Frequency Cutoff: <input id="wasm_biquadfilteri0" type="number" min="0" max="24000" step="1" value="1000"> Hz<br>Quality: <input id="wasm_biquadfilteri1" type="number" min="0" max="1" step="0.01" value="1"><br>Type of Filter: <select id="wasm_biquadfilteri2" oninput="if (this.value === \'3\' || this.value === \'5\' || this.value === \'6\') document.getElementById(\'gn\').style.display = \'\'; else document.getElementById(\'gn\').style.display = \'none\'; if (this.value === \'4\') document.getElementById(\'pr\').style.display = \'\'; else document.getElementById(\'pr\').style.display = \'none\';"><option value="0">(0) lowpass (attenuate higher frequencies)</option><option value="1">(1) highpass (attenuate lower frequencies)</option><option value="2">(2) bandpass (attenuates surrounding frequencies)</option><option value="3">(3) peak (amplifies or attenuates a frequency)</option><option value="4">(4) notch (attenuates a frequency)</option><option value="5">(5) lowshelf (amplifies or attenuates lower frequencies)</option><option value="6">(6) highshelf (amplifies or attenuates higher frequencies)</option><option value="7">(7) sallen-key lowpass (attenuate higher frequencies via simulated simplicity)</option><option value="8">(8) sallen-key highpass (attenuate lower frequencies via simulated simplicity)</option></select><div id="gn" style="display: none">Gain: <input id="wasm_biquadfilteri3" type="number" min="-1000" max="1000" step="0.02" value="0"> Db<br></div><div id="pr" style="display: none">Pole Radius (1 = exceedingly narrow notch, 0.7 = wide notch): <input id="wasm_biquadfilteri4" type="number" min="0" max="1" step="0.01" value="0.7"><br></div>',
		6,
		"wasm_biquadfilteri",
