...
const effectsList = [
	...
	[
		...
		'Noise Type: <select id="experimentalnoise0" oninput="if(this.value===\'triper\'){[\'text0\',\'text1\',\'text2\'].forEach((x,i)=>document.getElementById(x).textContent=`Frequency ${i+1} (in Hz)\';`);}else{document.getElementById(\'text0\').textContent=\'When To Change Base (in samples)\';document.getElementById(\'text1\').textContent=\'Loudness of White Noise\';document.getElementById(\'text2\').textContent=\'(not used)\';}"><option value="sah">sample-and-hold</option><option value="triper">Perlin noise (three Hz values)</option><option value="triper">Perlin noise (three Hz values)</option></select><br>Volume: <input id="experimentalnoise1" type="number" min="0" max="100" step="1" value="50" placeholder="Hover for info" style="width: 100px" title="How loud the experimental static is.">%<br><a id="text0">When To Change Base (in samples)</a>: <input id="experimentalnoise2" type="number" min="1" max="24000" step="1" value="12"><br><a id="text1">Loudness Of White Noise</a>: <input id="experimentalnoise3" type="number" min="0" max="24000" value="1"><br><a id="text2">(not used)</a>: <input id="experimentalnoise4" type="number" min="0" max="24000" value="1">',
		5,
		"experimentalnoise",
