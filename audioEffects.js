...
const effectsList = [
	...
	[
		...
		'Noise Type: <select id="noise0"><option value="wn">white noise</option><option value="bn">brown noise</option></select><br>Volume: <input id="noise1" type="number" min="0" max="100" step="1" value="50" placeholder="Hover for info" style="width: 100px" title="How loud the static is.">%',
		2,
		"noise",
		[Number, identifier]
	]
