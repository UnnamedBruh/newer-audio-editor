...
const effectsList = [
	...
	[
		...
		'Feedback Multiplier: <input id="wasm_combfeedback4filter0" type="number" min="-0.99" max="0.99" step="0.001" value="0.95"><br>Type of Filter: <select id="wasm_combfeedback4filter1"><option value="0">(0) lowpass (positive gain only)</option><option value="1">(1) highpass (positive gain only)</option></select><br>Comparison:<br><ul><li>4-tap comb filters can preserve resonance and punchiness, and generate rich harmonics that make percussion sound "punchy". However, depending on the implementation, this can also amplify or attenuate the audio.</li></ul>',
		2,
